...
| `src/wire/ipv6option.rs` | `emit` | 339 | 1 | refinement type error |
| `src/wire/mld.rs` | `mcast_addr` | 51 | 1 | refinement type error |
...
| `src/wire/tcp.rs` | `set_seq_number` | 429 | 1 | refinement type error |
| `src/wire/tcp.rs` | `set_ack_number` | 437 | 1 | refinement type error |
